...
struct hbw_config
{
   ...
   HmwKey::Config keycfg[10];             // 0x0704 - 0x0717
   HmwLinkKey::Config keyLinks[32];       // 0x0718 - 0x07D7
                                          // 0x07D8 - 0x0800
};
...
void HBWLcDim8Hw::configureZeroCrossDetection()
{
   ...
   portA.configure( Pin7Mask, PORT_OPC_PULLUP_gc, false, PORT_ISC_RISING_gc );
   portA.enableInterrupt0Source( Pin7Mask );
...
HmwDeviceHw::BasicConfig* HBWLcDim8Hw::getBasicConfig()
{
