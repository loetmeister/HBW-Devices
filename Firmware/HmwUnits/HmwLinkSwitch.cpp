...
#include "HmwLinkSwitch.h"
#include "HmwChannel.h"
#include "HmwDevice.h"


HmwLinkSwitch::HmwLinkSwitch( uint8_t _numLinks, Config* _links )
{
   numLinks = _numLinks;
   links = _links;
}
...
void HmwLinkSwitch::receiveKeyEvent( const uint32_t&  senderAddress, uint8_t senderChannel, uint8_t targetChannel, bool longPress, uint8_t keyNum )
{
